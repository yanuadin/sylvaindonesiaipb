...
class SylvaTraining extends Component
{
     ...
     * @description : other
     */
    public string $titleModal = 'Tambah Pelatihan Sylva';
    ...
    public function render()
    {
        ...
        $articles = PostModel::query()
            ...
            ->where('type', PostModel::TYPE_SYLVA_TRAINING)
            ->orderBy('updated_at', 'DESC')
            ->paginate(10)
            ->withQueryString();

        return view('livewire.admin.series.sylva-training')
            ->with([
                'articles' => $articles,
    ...
    {
        $this->type = PostModel::TYPE_SYLVA_TRAINING;
        ...
        $this->redirectRoute('admin.series.sylva-training');
    }
    ...
    {
        $this->submitMethod = '';
        $this->titleModal = 'Lihat Pelatihan Sylva';
    ...
    public function showEditModal(PostModel $post): void
    {
        ...
        $this->titleModal = 'Edit Pelatihan Sylva';
